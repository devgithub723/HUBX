...
// //     console.log(`Private message from ${from} to ${to}: ${message || 'File sent'}`);
// //     try {
...
// // Middleware
// app.use(cors({ origin: 'http://localhost:5173', credentials: true }));
// app.use(express.json()); // Moved above routes
// app.use('/api/auth', authRoutes);
// app.use('/api/messages', messageRoutes); // API route
// app.use('/api/upload', uploadRoute); // File uploads
